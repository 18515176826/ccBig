  ...
  cityName () {
    ...
    for (let i = 0, l = this.areas.length; i < l; i++) {
      ...
      if (this.inAreaCtx == i) {
        ...
        ctx.fillText(_.name, _.xCenter + translateX + (_.move ? _.move[0] : 0), _.yCenter + translateY + (_.move ? _.move[1] : 0))
      } else {
        ...
        let name = _.name
        if (!_.show) name = ''
        ctx.fillText(name, _.xCenter + translateX + translateX + (_.move ? _.move[0] : 0), _.yCenter + translateY + (_.move ? _.move[1] : 0))
      }
  ...
  event () {
    ...
    this.ele.addEventListener('click', function (e) {
      ...
      if (_self.inAreaCtx > -1) {
        if (_self.callback && _self.callback.click) { _self.callback.click(_self.inAreaCtx, _self.areas[_self.inAreaCtx], e)}
      }
    })
  }
